...
define(function(require, exports, module) {
    ...
    case 4: this.$ = {}; 
    break;
    case 5: var command = {}; command[$$[$0-1]] = $$[$0]; this.$ = command; 
    break;
    case 6: this.$ = $$[$0]; 
    break;
    case 7: this.$ = [$$[$0]]; 
    ...
    exports.parser = comment;
    exports.Parser = comment.Parser;
    exports.parse = function () { return comment.parse.apply(comment, arguments); }
    }
});